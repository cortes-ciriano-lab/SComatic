...
def initialize_parser():
	parser = argparse.ArgumentParser(description='Split bam file by cell types')
	...
	parser.add_argument('--id', type=str, default = 'scRNA_sample', help='Sample id', required = False)
	...
	parser.add_argument('--max_nM', type=int, default = 1000, help='Maximum number of mismatched permitted to consider the read [Default: 1000]', required = False)
	parser.add_argument('--min_MQ', type=int, default = 255, help='Minimum mapping quality required to consider the read [Default: 255]', required = False)
	parser.add_argument('--n_trim', type=int, default = 0, help='Number of bases trimmed (setting the base quality to 0) at the beginning and end of the read [Default: 0]', required = False)
