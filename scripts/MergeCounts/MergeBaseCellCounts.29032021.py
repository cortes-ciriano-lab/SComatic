...
def initialize_parser():
	...
	parser.add_argument('--tsv_folder', type=str, default=1, help='Folder with cell/base count files (tsv) per cell type. Avoid not desired tsv files in this folder', required = True)   
	parser.add_argument('--out_file', help='Prefix out files', required = True)
	return (parser)
