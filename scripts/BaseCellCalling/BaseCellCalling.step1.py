...
def initialize_parser():
	...
	parser.add_argument('--alpha1', type=float, default = 0.260288007167716, help='Alpha parameter for beta distribution of read counts. [Default: 0.260288007167716]', required = False)
	parser.add_argument('--beta1', type=float, default = 173.94711910763732, help='Beta parameter for beta distribution of read counts. [Default: 173.94711910763732]', required = False)
	parser.add_argument('--alpha2', type=float, default = 0.08354121346569514, help='Alpha parameter for beta distribution of cell counts. [Default: 0.08354121346569514]', required = False)
	parser.add_argument('--beta2', type=float, default = 103.47683488327257, help='Beta parameter for beta distribution of cell counts. [Default: 103.47683488327257]', required = False)
	return (parser)
