...
def initialize_parser():
	...
	parser.add_argument('--chrom', type=str, help='Chromosome to be analysed. --chrom all Set this flag to analyse all chromosomes', required = True)
	parser.add_argument('--out_folder', default = '.', help='Output folder', required = False)
	...
	parser.add_argument('--bed', type=str, default='', help='Three-column bed file listing the chromosome, start and end for those regions to be analysed.', required = False)
	parser.add_argument('--bed_out', type=str, default='', help='Three-column bed file listing the chromosome, start and end for those regions to be ignored.', required = False)
