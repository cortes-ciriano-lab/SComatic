...
def initialize_parser():
	...
	parser.add_argument('--bed_out', type=str, default='', help='Regions to ignore in the analysis. Three-column bed file', required = False)
	parser.add_argument('--min_ac', type=int, default = 0, help='Minimum alternative count to consider the genomic site. Default = 0', required = False)
	parser.add_argument('--min_af', type=float, default = 0, help='Minimum alternative allele fraction to consider the genomic site. Default = 0', required = False)
